...
public class ShiyanyuxiView extends ShiyanyuxiEntity implements Serializable {
	...
	public ShiyanyuxiView() {

	}

	public ShiyanyuxiView(ShiyanyuxiEntity shiyanyuxiEntity) {
		try {
			BeanUtils.copyProperties(this, shiyanyuxiEntity);
