            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">课程类型管理</li>
                        <li class="breadcrumb-item active">编辑课程类型</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">课程类型表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryShiyanpaike";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "shiyanpaike_types";
            data["dicName"] = "课程类型名称";
